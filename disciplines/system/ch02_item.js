...
Chapters.register('system', {
    ...
    checklist: [
        { id: 'c2a', text: 'Every item function has a stable unique ID.',
          help: 'Auto-generated (ITEMF-NNNN) and persisted. They never change once assigned, so cross-document references stay valid even when names get reworded.' },
        ...
        { id: 'c2d', text: 'Operating modes enumerated with IDs.',
          help: 'Operating Modes table above. Each mode has a stable ID (MODE-NNNN).' },
        ...
        { id: 'c2g', text: 'Assumptions of use enumerated with IDs.',
          help: 'AoUs are statements about the operating context the item depends on but does not enforce — closure or invalidation must be tracked.' },
